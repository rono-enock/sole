...
public class saveconfirm extends Activity implements B4AActivity{
	public static saveconfirm mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.saveconfirm");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (saveconfirm).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.saveconfirm");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.KashLend.cleanpesa.saveconfirm", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (saveconfirm) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (saveconfirm) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (saveconfirm) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (saveconfirm) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public anywheresoftware.b4a.objects.ButtonWrapper _btnapplynow = null;
...
anywheresoftware.b4a.objects.collections.List _list = null;
 ...
 //BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"SaveConfirmPage\")";
mostCurrent._activity.LoadLayout("SaveConfirmPage",mostCurrent.activityBA);
...
mostCurrent._panel1.setBackground((android.graphics.drawable.Drawable)(_pagecolors.getObject()));
 //BA.debugLineNum = 30;BA.debugLine="Dim phone As String";
_phone = "";
...
_list = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"data.dat");
 //BA.debugLineNum = 35;BA.debugLine="phone=list.Get(1)";
_phone = BA.ObjectToString(_list.Get((int) (1)));
 };
 //BA.debugLineNum = 38;BA.debugLine="Label1.Text=$\"Your savings of KShs.${Starter.savi";
mostCurrent._label1.setText(BA.ObjectToCharSequence(("Your savings of KShs."+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._starter._saving /*int*/ ))+" has been received and credited to phone number: ")+_phone+("\n"+"Tab the \"Apply Now\" button to proceed loan application")));
 //BA.debugLineNum = 40;BA.debugLine="Label1.TextColor=Colors.Black";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 41;BA.debugLine="Label1.TextSize=14";
mostCurrent._label1.setTextSize((float) (14));
 //BA.debugLineNum = 43;BA.debugLine="BtnApplyNow.Text=\"Apply Now\"";
mostCurrent._btnapplynow.setText(BA.ObjectToCharSequence("Apply Now"));
 //BA.debugLineNum = 44;BA.debugLine="BtnApplyNow.TextColor=Colors.Black";
mostCurrent._btnapplynow.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 45;BA.debugLine="BtnApplyNow.TextSize=15";
mostCurrent._btnapplynow.setTextSize((float) (15));
...
public static String  _btnapplynow_click() throws Exception{
 //BA.debugLineNum = 58;BA.debugLine="Sub BtnApplyNow_Click";
 //BA.debugLineNum = 59;BA.debugLine="StartActivity(Apply)";
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private BtnApplyNow As Button";
mostCurrent._btnapplynow = new anywheresoftware.b4a.objects.ButtonWrapper();
