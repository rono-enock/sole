...
public class apply extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.apply");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.apply");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.KashLend.cleanpesa.apply", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public anywheresoftware.b4a.objects.LabelWrapper _labelperiod = null;
public anywheresoftware.b4a.objects.SpinnerWrapper _spinnerperiod = null;
public anywheresoftware.b4a.objects.LabelWrapper _label4 = null;
public anywheresoftware.b4a.objects.ButtonWrapper _btnapply = null;
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _pagecolors = null;
 ...
 //BA.debugLineNum = 28;BA.debugLine="Activity.LoadLayout(\"ApplyPage\")";
...
mostCurrent._panel1.setBackground((android.graphics.drawable.Drawable)(_pagecolors.getObject()));
 //BA.debugLineNum = 35;BA.debugLine="edtAmount.InputType=edtAmount.INPUT_TYPE_NUMBERS";
mostCurrent._edtamount.setInputType(mostCurrent._edtamount.INPUT_TYPE_NUMBERS);
 //BA.debugLineNum = 37;BA.debugLine="Label1.Text=\"Enter an amount you'll be able to re";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Enter an amount you'll be able to repay!"));
...
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 39;BA.debugLine="Label1.TextSize=15";
mostCurrent._label1.setTextSize((float) (15));
 //BA.debugLineNum = 41;BA.debugLine="Label4.Text=\"Interest will be calculated as per t";
mostCurrent._label4.setText(BA.ObjectToCharSequence("Interest will be calculated as per the period selected above"));
 //BA.debugLineNum = 42;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 43;BA.debugLine="Label4.TextSize=15";
mostCurrent._label4.setTextSize((float) (15));
 //BA.debugLineNum = 45;BA.debugLine="LabelAmount.Text=\"Amount:\"";
mostCurrent._labelamount.setText(BA.ObjectToCharSequence("Amount:"));
 //BA.debugLineNum = 46;BA.debugLine="LabelAmount.TextColor=Colors.Black";
mostCurrent._labelamount.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 47;BA.debugLine="LabelAmount.TextSize=14";
mostCurrent._labelamount.setTextSize((float) (14));
 //BA.debugLineNum = 49;BA.debugLine="LabelPeriod.Text=\"Choose a repayment period:\"";
mostCurrent._labelperiod.setText(BA.ObjectToCharSequence("Choose a repayment period:"));
 //BA.debugLineNum = 50;BA.debugLine="LabelPeriod.TextColor=Colors.Black";
mostCurrent._labelperiod.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 51;BA.debugLine="LabelPeriod.TextSize=14";
mostCurrent._labelperiod.setTextSize((float) (14));
 //BA.debugLineNum = 53;BA.debugLine="BtnApply.Text=\"Apply\"";
mostCurrent._btnapply.setText(BA.ObjectToCharSequence("Apply"));
 //BA.debugLineNum = 54;BA.debugLine="BtnApply.TextColor=Colors.Black";
mostCurrent._btnapply.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 55;BA.debugLine="BtnApply.TextSize=15";
mostCurrent._btnapply.setTextSize((float) (15));
...
public static String  _btnapply_click() throws Exception{
anywheresoftware.b4a.objects.collections.List _list = null;
 //BA.debugLineNum = 72;BA.debugLine="Sub BtnApply_Click";
 //BA.debugLineNum = 73;BA.debugLine="Dim list As List";
_list = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 74;BA.debugLine="list.Initialize";
_list.Initialize();
 //BA.debugLineNum = 75;BA.debugLine="list.Add(edtAmount.Text)";
_list.Add((Object)(mostCurrent._edtamount.getText()));
 //BA.debugLineNum = 76;BA.debugLine="list.Add(SpinnerPeriod.SelectedItem)";
_list.Add((Object)(mostCurrent._spinnerperiod.getSelectedItem()));
 //BA.debugLineNum = 77;BA.debugLine="File.WriteList(File.DirInternal,\"data4.dat\",list)";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"data4.dat",_list);
 //BA.debugLineNum = 78;BA.debugLine="If Not(edtAmount.Text=\"\") And Not(edtAmount.Text<";
if (anywheresoftware.b4a.keywords.Common.Not((mostCurrent._edtamount.getText()).equals("")) && anywheresoftware.b4a.keywords.Common.Not((double)(Double.parseDouble(mostCurrent._edtamount.getText()))<100) && anywheresoftware.b4a.keywords.Common.Not((double)(Double.parseDouble(mostCurrent._edtamount.getText()))>(double)(Double.parseDouble(mostCurrent._starter._limit /*String*/ )))) { 
 //BA.debugLineNum = 79;BA.debugLine="StartActivity(ApplyConfirm)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._applyconfirm.getObject()));
 }else {
 //BA.debugLineNum = 81;BA.debugLine="MsgboxAsync($\"Enter the correct amount (between";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence(("Enter the correct amount (between Kshs.100 and "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._starter._limit /*String*/ ))+")")),BA.ObjectToCharSequence("Error"),processBA);
 };
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private LabelAmount As Label";
...
mostCurrent._edtamount = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private LabelPeriod As Label";
mostCurrent._labelperiod = new anywheresoftware.b4a.objects.LabelWrapper();
...
mostCurrent._label4 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private BtnApply As Button";
mostCurrent._btnapply = new anywheresoftware.b4a.objects.ButtonWrapper();
