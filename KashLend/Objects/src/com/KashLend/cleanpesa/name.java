...
public class name extends Activity implements B4AActivity{
	public static name mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.name");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (name).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.name");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.KashLend.cleanpesa.name", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (name) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (name) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (name) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (name) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _pagecolors = null;
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"NamesPage\")";
mostCurrent._activity.LoadLayout("NamesPage",mostCurrent.activityBA);
...
mostCurrent._panel1.setBackground((android.graphics.drawable.Drawable)(_pagecolors.getObject()));
 //BA.debugLineNum = 31;BA.debugLine="edtName.Hint=\"Full names\"";
mostCurrent._edtname.setHint("Full names");
 //BA.debugLineNum = 32;BA.debugLine="edtName.TextColor=Colors.Black";
mostCurrent._edtname.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 33;BA.debugLine="edtName.TextSize=14";
...
mostCurrent._edtphone.setInputType(mostCurrent._edtphone.INPUT_TYPE_NUMBERS);
 //BA.debugLineNum = 37;BA.debugLine="edtPhone.Hint=\"Phone number\"";
mostCurrent._edtphone.setHint("Phone number");
 //BA.debugLineNum = 38;BA.debugLine="edtPhone.TextColor=Colors.Black";
mostCurrent._edtphone.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 39;BA.debugLine="edtPhone.TextSize=14";
mostCurrent._edtphone.setTextSize((float) (14));
 //BA.debugLineNum = 41;BA.debugLine="BtnNext.Text=\"Next\"";
mostCurrent._btnnext.setText(BA.ObjectToCharSequence("Next"));
 //BA.debugLineNum = 42;BA.debugLine="BtnNext.TextColor=Colors.Black";
mostCurrent._btnnext.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 43;BA.debugLine="BtnNext.TextSize=15";
...
anywheresoftware.b4a.objects.collections.List _list = null;
 //BA.debugLineNum = 56;BA.debugLine="Sub BtnNext_Click";
 //BA.debugLineNum = 58;BA.debugLine="Dim list As List";
_list = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 59;BA.debugLine="list.Initialize";
_list.Initialize();
 //BA.debugLineNum = 60;BA.debugLine="list.Add(edtName.Text)";
_list.Add((Object)(mostCurrent._edtname.getText()));
 //BA.debugLineNum = 61;BA.debugLine="list.Add(edtPhone.Text)";
_list.Add((Object)(mostCurrent._edtphone.getText()));
 //BA.debugLineNum = 62;BA.debugLine="File.WriteList(File.DirInternal,\"data.dat\",list)";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"data.dat",_list);
 //BA.debugLineNum = 64;BA.debugLine="If Not (edtName.Text=\"\") And (edtName.Text.Length";
if (anywheresoftware.b4a.keywords.Common.Not((mostCurrent._edtname.getText()).equals("")) && (mostCurrent._edtname.getText().length()>6) && anywheresoftware.b4a.keywords.Common.Not((mostCurrent._edtphone.getText()).equals("")) && (mostCurrent._edtphone.getText().length()==10)) { 
 //BA.debugLineNum = 65;BA.debugLine="StartActivity(Id_Number)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._id_number.getObject()));
 }else {
 //BA.debugLineNum = 68;BA.debugLine="MsgboxAsync(\"Enter the correct details\",\"Error\")";
