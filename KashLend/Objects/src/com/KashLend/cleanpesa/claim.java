...
public class claim extends Activity implements B4AActivity{
	public static claim mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.claim");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (claim).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.KashLend.cleanpesa", "com.KashLend.cleanpesa.claim");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.KashLend.cleanpesa.claim", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (claim) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (claim) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (claim) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (claim) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _pagecolors = null;
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"ClaimPage\")";
mostCurrent._activity.LoadLayout("ClaimPage",mostCurrent.activityBA);
...
mostCurrent._panel1.setBackground((android.graphics.drawable.Drawable)(_pagecolors.getObject()));
 //BA.debugLineNum = 32;BA.debugLine="BtnClaim.Text=\"Claim\"";
mostCurrent._btnclaim.setText(BA.ObjectToCharSequence("Claim"));
 //BA.debugLineNum = 33;BA.debugLine="BtnClaim.TextColor=Colors.Black";
mostCurrent._btnclaim.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 34;BA.debugLine="BtnClaim.TextSize=15";
mostCurrent._btnclaim.setTextSize((float) (15));
 //BA.debugLineNum = 36;BA.debugLine="edtPhone.Hint=\"Enter the phone number to be credi";
mostCurrent._edtphone.setHint("Enter the phone number to be credited");
 //BA.debugLineNum = 37;BA.debugLine="edtPhone.TextColor=Colors.Black";
mostCurrent._edtphone.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 38;BA.debugLine="edtPhone.TextSize=14";
mostCurrent._edtphone.setTextSize((float) (14));
 //BA.debugLineNum = 40;BA.debugLine="edtPhone.InputType=edtPhone.INPUT_TYPE_NUMBERS";
mostCurrent._edtphone.setInputType(mostCurrent._edtphone.INPUT_TYPE_NUMBERS);
 //BA.debugLineNum = 41;BA.debugLine="edtPin.InputType=edtPin.INPUT_TYPE_NUMBERS";
mostCurrent._edtpin.setInputType(mostCurrent._edtpin.INPUT_TYPE_NUMBERS);
 //BA.debugLineNum = 43;BA.debugLine="edtPin.Hint=\"Enter password\"";
mostCurrent._edtpin.setHint("Enter password");
 //BA.debugLineNum = 44;BA.debugLine="edtPin.TextColor=Colors.Black";
mostCurrent._edtpin.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 45;BA.debugLine="edtPin.TextSize=14";
mostCurrent._edtpin.setTextSize((float) (14));
 //BA.debugLineNum = 47;BA.debugLine="Label1.Text=\"Note that claiming your savings stop";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Note that claiming your savings stops the entire loan processing"));
...
public ResumableSub_BtnClaim_Click(com.KashLend.cleanpesa.claim parent) {
this.parent = parent;
}
com.KashLend.cleanpesa.claim parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 62;BA.debugLine="Dim list As List";
_list = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 63;BA.debugLine="list.Initialize";
_list.Initialize();
 //BA.debugLineNum = 64;BA.debugLine="list.Add(edtPhone.Text)";
_list.Add((Object)(parent.mostCurrent._edtphone.getText()));
 //BA.debugLineNum = 65;BA.debugLine="File.WriteList(File.DirInternal,\"data6.dat\",list)";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"data6.dat",_list);
 //BA.debugLineNum = 67;BA.debugLine="Dim lists As List";
_lists = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 68;BA.debugLine="Dim password As String";
_password = "";
 //BA.debugLineNum = 69;BA.debugLine="lists.Initialize";
_lists.Initialize();
 //BA.debugLineNum = 70;BA.debugLine="If File.Exists(File.DirInternal,\"data1.dat\")Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 71;BA.debugLine="lists=File.ReadList(File.DirInternal,\"data1.dat\"";
_lists = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"data1.dat");
 //BA.debugLineNum = 72;BA.debugLine="password=lists.Get(0)";
_password = BA.ObjectToString(_lists.Get((int) (0)));
 if (true) break;
;
 //BA.debugLineNum = 74;BA.debugLine="If Not(edtPhone.Text=\"\") And (edtPhone.Text.Lengt";

case 4:
//if
this.state = 9;
if (anywheresoftware.b4a.keywords.Common.Not((parent.mostCurrent._edtphone.getText()).equals("")) && (parent.mostCurrent._edtphone.getText().length()==10) && anywheresoftware.b4a.keywords.Common.Not((parent.mostCurrent._edtpin.getText()).equals("")) && ((parent.mostCurrent._edtpin.getText()).equals(_password))) { 
this.state = 6;
}else {
this.state = 8;
}if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 80;BA.debugLine="MsgboxAsync(\"Enter the correct details\",\"Error\")";
...
mostCurrent._edtphone = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private edtPin As EditText";
mostCurrent._edtpin = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private BtnClaim As Button";
