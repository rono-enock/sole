...
public class membership extends Activity implements B4AActivity{
	public static membership mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.vukapesa.cleandeal", "com.vukapesa.cleandeal.membership");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (membership).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.vukapesa.cleandeal", "com.vukapesa.cleandeal.membership");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.vukapesa.cleandeal.membership", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (membership) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (membership) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (membership) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (membership) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _page = null;
 ...
 //BA.debugLineNum = 24;BA.debugLine="Activity.LoadLayout(\"Member\")";
mostCurrent._activity.LoadLayout("Member",mostCurrent.activityBA);
 //BA.debugLineNum = 25;BA.debugLine="Dim page As ColorDrawable";
_page = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 26;BA.debugLine="page.Initialize(Inuka.pages,0)";
_page.Initialize(mostCurrent._inuka._pages /*int*/ ,(int) (0));
 //BA.debugLineNum = 27;BA.debugLine="Panel1.Background=page";
mostCurrent._panel1.setBackground((android.graphics.drawable.Drawable)(_page.getObject()));
 //BA.debugLineNum = 29;BA.debugLine="BtnBack.Color=btn";
mostCurrent._btnback.setColor(_btn);
 //BA.debugLineNum = 30;BA.debugLine="BtnBack.Text=\"Back\"";
mostCurrent._btnback.setText(BA.ObjectToCharSequence("Back"));
 //BA.debugLineNum = 31;BA.debugLine="BtnBack.TextColor=Colors.Black";
mostCurrent._btnback.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 32;BA.debugLine="BtnBack.TextSize=15";
mostCurrent._btnback.setTextSize((float) (15));
 //BA.debugLineNum = 34;BA.debugLine="edtCode.Hint=\"PASTE THE MPESA CODE RECIEVED HERE\"";
mostCurrent._edtcode.setHint("PASTE THE MPESA CODE RECIEVED HERE");
 //BA.debugLineNum = 35;BA.debugLine="edtCode.HintColor=Colors.Magenta";
mostCurrent._edtcode.setHintColor(anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 36;BA.debugLine="edtCode.TextColor=Colors.Black";
mostCurrent._edtcode.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 37;BA.debugLine="edtCode.TextSize=14";
mostCurrent._edtcode.setTextSize((float) (14));
 //BA.debugLineNum = 38;BA.debugLine="edtCode.Color=Colors.White";
mostCurrent._edtcode.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 40;BA.debugLine="Label1.Text=$\"Welcome to ${Starter.compname}. Joi";
mostCurrent._label1.setText(BA.ObjectToCharSequence(("Welcome to "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._starter._compname /*String*/ ))+". Join us and unlock your potentials!\n"+"Being a member enables you to qualify for higher loans and reduces the interest rates.\n"+"To be a member,the company wants your to pay a membership of Ksh.30 To Till No. And paste the MPESA code received To the space below.")));
 //BA.debugLineNum = 43;BA.debugLine="Label1.TextSize=14";
mostCurrent._label1.setTextSize((float) (14));
 //BA.debugLineNum = 44;BA.debugLine="Label1.TextColor=Colors.Black";
...
String _mcode = "";
 //BA.debugLineNum = 57;BA.debugLine="Sub BtnBack_Click";
 //BA.debugLineNum = 63;BA.debugLine="Dim Mcode As String";
_mcode = "";
 //BA.debugLineNum = 64;BA.debugLine="Mcode = edtCode.Text.Trim";
_mcode = mostCurrent._edtcode.getText().trim();
 //BA.debugLineNum = 66;BA.debugLine="If Mcode = \"\" Or Mcode.Length > 142 Then";
if ((_mcode).equals("") || _mcode.length()>142) { 
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(Directory)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 71;BA.debugLine="edtCode.Text = \"\"";
mostCurrent._edtcode.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 72;BA.debugLine="edtCode.Hint = \"INVALID MPESA CODE!\"";
mostCurrent._edtcode.setHint("INVALID MPESA CODE!");
 //BA.debugLineNum = 73;BA.debugLine="edtCode.HintColor = Colors.Red";
mostCurrent._edtcode.setHintColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 74;BA.debugLine="edtCode.Gravity = Gravity.CENTER";
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private edtCode As EditText";
mostCurrent._edtcode = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private BtnBack As Button";
