...
public class directory extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.vukapesa.cleandeal", "com.vukapesa.cleandeal.directory");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.vukapesa.cleandeal", "com.vukapesa.cleandeal.directory");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.vukapesa.cleandeal.directory", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public anywheresoftware.b4a.objects.ButtonWrapper _btnchecklimit = null;
public anywheresoftware.b4a.objects.ButtonWrapper _btnmember = null;
...
String _nem = "";
 ...
 //BA.debugLineNum = 29;BA.debugLine="Activity.LoadLayout(\"DirectoryPage\")";
...
mostCurrent._panel1.setBackground((android.graphics.drawable.Drawable)(_page.getObject()));
 //BA.debugLineNum = 37;BA.debugLine="Dim lists As List";
_lists = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 38;BA.debugLine="lists.Initialize";
_lists.Initialize();
 //BA.debugLineNum = 39;BA.debugLine="Dim names As String";
_names = "";
 //BA.debugLineNum = 40;BA.debugLine="If File.Exists(File.DirInternal,\"data.dat\")Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"data.dat")) { 
 //BA.debugLineNum = 41;BA.debugLine="lists=File.ReadList(File.DirInternal,\"data.dat\")";
_lists = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"data.dat");
 //BA.debugLineNum = 42;BA.debugLine="names=lists.Get(0)";
_names = BA.ObjectToString(_lists.Get((int) (0)));
 };
 //BA.debugLineNum = 44;BA.debugLine="Dim nem As String";
_nem = "";
 //BA.debugLineNum = 45;BA.debugLine="nem=names";
_nem = _names;
 //BA.debugLineNum = 46;BA.debugLine="Label1.Text=$\"Dear \"$&names&$\" your details has b";
mostCurrent._label1.setText(BA.ObjectToCharSequence(("Dear ")+_names+(" your details has been saved successfully.")));
...
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 48;BA.debugLine="Label1.TextSize=20";
mostCurrent._label1.setTextSize((float) (20));
 //BA.debugLineNum = 50;BA.debugLine="BtnProceed.Text=\"Proceed to Loan Application\"";
mostCurrent._btnproceed.setText(BA.ObjectToCharSequence("Proceed to Loan Application"));
 //BA.debugLineNum = 51;BA.debugLine="BtnProceed.TextColor=Colors.Black";
mostCurrent._btnproceed.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 52;BA.debugLine="BtnProceed.TextSize=15";
...
public static String  _btnproceed_click() throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Sub BtnProceed_Click";
 //BA.debugLineNum = 69;BA.debugLine="StartActivity(EducLevel)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._educlevel.getObject()));
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private BtnCheckLimit As Button";
mostCurrent._btnchecklimit = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private BtnMember As Button";
mostCurrent._btnmember = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private BtnProceed As Button";
