...
views.get("edtname").vw.setHeight((int)((12d / 100 * height)));
...
views.get("btnlogin").vw.setHeight((int)((10d / 100 * height)));
views.get("btnlogin").vw.setTop((int)((views.get("edtpass").vw.getTop() + views.get("edtpass").vw.getHeight())+(60d * scale)));
