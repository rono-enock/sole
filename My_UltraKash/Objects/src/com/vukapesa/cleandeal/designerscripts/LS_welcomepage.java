...
views.get("label1").vw.setTop((int)((30d * scale)));
...
views.get("label2").vw.setHeight((int)((30d / 100 * height)));
views.get("label2").vw.setTop((int)((views.get("label1").vw.getTop() + views.get("label1").vw.getHeight())+(30d * scale)));
views.get("btnstart").vw.setLeft((int)((5d / 100 * width)));
views.get("btnstart").vw.setWidth((int)((95d / 100 * width) - ((5d / 100 * width))));
views.get("btnstart").vw.setHeight((int)((12d / 100 * height)));
views.get("btnstart").vw.setTop((int)((views.get("label2").vw.getTop() + views.get("label2").vw.getHeight())+(90d * scale)));
