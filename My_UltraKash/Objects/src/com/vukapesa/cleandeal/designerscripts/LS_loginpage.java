...
views.get("label2").vw.setTop((int)((60d * scale)));
...
views.get("label1").vw.setTop((int)((views.get("label2").vw.getTop() + views.get("label2").vw.getHeight())+(10d * scale)));
...
views.get("btnlogin").vw.setTop((int)((views.get("label1").vw.getTop() + views.get("label1").vw.getHeight())+(40d * scale)));
views.get("btnsignup").vw.setTop((int)((views.get("btnlogin").vw.getTop() + views.get("btnlogin").vw.getHeight())+(30d * scale)));
views.get("btnsignup").vw.setLeft((int)((5d / 100 * width)));
views.get("btnsignup").vw.setWidth((int)((95d / 100 * width) - ((5d / 100 * width))));
views.get("btnsignup").vw.setHeight((int)((12d / 100 * height)));
