...
public class acclogin extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.vukapesa.cleandeal", "com.vukapesa.cleandeal.acclogin");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.vukapesa.cleandeal", "com.vukapesa.cleandeal.acclogin");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.vukapesa.cleandeal.acclogin", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Dim page As Int = Colors.ARGB(147,107,228,255)";
_page = anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (147),(int) (107),(int) (228),(int) (255));
